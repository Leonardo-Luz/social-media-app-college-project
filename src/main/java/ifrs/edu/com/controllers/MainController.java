...
public class MainController {
    ...
    private void initialize() {
        ...
        columnMessage.setCellFactory(new Callback<TableColumn<Message, String>, TableCell<Message, String>>() {
            @Override
                ...
                return new TableCell<Message, String>() {
                    ...
                    public void updateItem(String item, boolean empty) {
                        ...
                        if (!isEmpty()) {
                            ...
                            text.setWrappingWidth(columnMessage.getWidth());
        ...
        columnMessage.setResizable(true);
    }
    ...
    public void clear() {
        ...
        this.messagesTable.setItems(null);
        chatInput.setText("");
        loadTable();
    }
